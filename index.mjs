...
function checkAccount(accountName) {
    if (!fs.existsSync(`accounts/${accountName}.json`)) {
        console.log(chalk.bgRedBright.black('Essa conta não existe, tente novamente'))
        return false
    }
...
function addAmount(accountName, amount) {
    ...
    console.log(chalk.greenBright(`Foi depositado o valor de R$${amount} na sua conta!`))
}
...
function removeAmount(accountName, amount) {
    ...
    if (!amount) {
        ...
        console.log(chalk.bgRedBright.black('Ocorreu um erro, tente novamente!'),)
    ...
    console.log(chalk.greenBright(`Foi realizado um saque de R$${amount} na conta!`))
    operation()
}
